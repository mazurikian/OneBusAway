...
Create a new flavor file or copy an existing brand configuration and rename it to your brand name:

```bash
cp flavors/oba.gradle flavors/mybrand.gradle
```

Edit the file and update:

1. **Flavor name** - Change the flavor block name to `mybrand {`
...
4. Compare your file against an existing working flavor file
